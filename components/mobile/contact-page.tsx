...
export default function ContactPage({ onBack }: ContactPageProps) {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      handle: "linGREEDO",
      icon: <img src="/icons/github.svg" alt="Github Icon" className="w-6 h-6" />,
    ...
    },
    {
      ...
      icon: <img src="/icons/linkedin.svg" alt="LinkedIn Icon" className="w-6 h-6" />,
    ...
    },
    {
      ...
      handle: "lin_greed",
      icon: <img src="/icons/discord.svg" alt="Discord Icon" className="w-6 h-6" />,

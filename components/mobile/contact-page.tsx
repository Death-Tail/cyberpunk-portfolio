      ...
      <div className="relative space-y-6">
        ...
        <div className="relative border border-white/60 p-6 bg-white/40 rounded-3xl backdrop-blur-3xl shadow-xl ring-1 ring-white/60">
          <div className="flex items-center mb-4">
            <BsArrowRightCircle className="w-4 h-4 text-memory-pink mr-2" />
            <span className="text-stone-950 text-sm font-black tracking-widest uppercase">Partially Available</span>
          </div>
          <div className="text-stone-800 text-xs mb-4 font-bold leading-relaxed">I am currently working as Data Engineer and I am busy with my work, but I will try my best to respond as soon as possible.</div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="text-stone-950 font-black text-xs uppercase">GMT+3 (Hawler)</div>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      {contact.preferred && (
                        <span className="px-3 py-1 bg-pink-100 text-pink-700 text-[9px] font-black rounded-full uppercase tracking-widest">
                          Preferred
                        </span>
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex items-center font-black text-[10px] text-stone-950/40 uppercase tracking-widest">
                        <Clock className="w-3.5 h-3.5 mr-2 text-pink-400" />
        ...
        <div className="relative border border-white/60 p-6 bg-white/40 rounded-3xl backdrop-blur-3xl shadow-xl ring-1 ring-white/60">
          ...
          <div className="space-y-3 text-[11px] text-stone-800 font-bold">
            <p className="flex items-start gap-2">
              <span className="text-pink-500 font-black leading-none">•</span>
            ...
            <p className="flex items-start gap-2">
              ...
              <span
                ...
                className="text-stone-950 cursor-pointer hover:text-pink-600 transition-colors font-black relative underline decoration-pink-400/40"

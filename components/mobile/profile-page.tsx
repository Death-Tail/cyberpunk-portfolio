      ...
      <div className="relative space-y-6">
        ...
        <div className="relative">
          <div className="relative w-24 h-24 mx-auto mb-4">
            ...
            />
            <div className="absolute inset-2px bg-linear-to-br from-teal-500/10 to-teal-900/20"
              style={{
                clipPath: "polygon(25% 0%, 75% 0%, 100% 25%, 100% 75%, 75% 100%, 25% 100%, 0% 75%, 0% 25%)",
              }}
            />
            ...
            />
            <div className="absolute -top-1 -left-1 w-2 h-2 bg-teal-400 rounded-full opacity-60" />
            <div className="absolute -top-1 -right-1 w-2 h-2 bg-teal-400 rounded-full opacity-60" />
            <div className="absolute -bottom-1 -left-1 w-2 h-2 bg-teal-400 rounded-full opacity-60" />
        ...
        {/* Bio Section */}
        <div className="relative border-l-2 border-teal-600 pl-4">
          <div className="flex items-center mb-3">
            <div className="w-2 h-2 bg-teal-600 mr-2" />
            <span className="text-teal-400 text-xs tracking-wider">NEURAL_IMPRINT</span>
          </div>
          <div className="relative p-4 bg-teal-500/5 border border-teal-500/30"
            style={{
          ...
          >
            ...
            <br/>
            <p>
              <span className="text-teal-500">&gt;</span> Certified in advanced English communication (B2 Upper
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="relative p-3 bg-teal-500/10 border border-teal-500/30 text-center">
            <div className="absolute inset-0 opacity-20"
              style={{
                backgroundImage: `radial-gradient(circle at 1px 1px, rgba(220, 38, 38, 0.6) 0.5px, transparent 0)`,
                backgroundSize: "4px 4px",
            ...
            />
            <div className="text-lg font-bold text-teal-400">2+</div>
            <div className="text-teal-400/70 text-xs">Years Exp</div>
          </div>
          <div className="relative p-3 bg-teal-500/10 border border-teal-500/30 text-center">
            <div className="absolute inset-0 opacity-20"
              style={{
          ...
          <div className="relative p-3 bg-teal-500/10 border border-teal-500/30 text-center">
            ...
            <div className="text-teal-400/70 text-xs">Tech Stack</div>
          </div>
        </div>
      </div>
    </BasePage>

      ...
      <div className="space-y-4 h-full overflow-y-auto">
        <div className="border-l-2 border-neutral-600 pl-4">
          <div className="flex items-center mb-4">
            <div className="w-2 h-2 bg-neutral-600 mr-2"></div>
            <span className="text-neutral-400 text-xs tracking-wider">PROJECT_DATABASE</span>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {projects.map((project, index) => (
            <div
              key={index}
              className=" bg-neutral-800/40 hover:bg-neutral-800/60 transition-colors p-4"
            >
                ...
                <div className="flex items-start space-x-3 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-neutral-300 font-bold text-sm">{project.title}</h3>
                      <span
                    ...
                    <div className="mb-3">
                      <div className="text-xs text-neutral-400 mb-1">TECH_STACK:</div>
                      <div className="flex flex-wrap gap-1">
                        {project.tech.map((tech, techIndex) => (
                          <span
                            key={techIndex}
                            className="px-2 py-0.5 bg-neutral-700/50 border border-neutral-500/30 text-neutral-300 text-xs"
                          >
                            {tech}
                          </span>
                        ))}
                    ...
                    <div className="mb-3">
                      <div className="text-xs text-neutral-400 mb-1">KEY_ACHIEVEMENTS:</div>

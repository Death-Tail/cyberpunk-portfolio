...
export function MusicPlayerWidget({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "w-[400px] pl-1.5 rounded-3xl bg-linear-to-br from-neutral-900 via-zinc-900 to-neutral-800",
      ...
      <div className="relative p-4 flex gap-4">
        ...
        <div className="relative w-32 h-32 shrink-0">
          ...
          >
            ...
            {/* spindle */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-neutral-100 shadow-[0_0_6px_rgba(255,255,255,0.7)]" />
        ...
        <div className="flex-1 flex flex-col justify-between py-1">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div
                className={cn(
                  ...
                  isPlaying ? "bg-neutral-900/70" : "bg-neutral-500/90 shadow-[0_0_6px_rgba(248,113,113,0.7)]"
                )}
              />
            </div>
            ...
            <div className="w-[120px] h-5 rounded-full bg-black/40 border border-black/70 px-1 flex items-center">
              <div className="flex-1 h-2 rounded-full bg-linear-to-r from-emerald-400 via-yellow-300 to-neutral-400/80 overflow-hidden">
                <div

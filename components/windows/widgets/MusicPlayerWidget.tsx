      ...
      <div className="relative p-5 flex items-center gap-4 bg-linear-to-b from-white/5 to-transparent">
        ...
        <div className="relative shrink-0">
          <div className={cn(
            ...
            <div className={cn("w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center text-teal-400", )}>
        ...
        <div className="flex flex-col overflow-hidden">
          ...
          <p className={cn("text-xs truncate w-full mt-0.5 font-medium text-teal-400")}>

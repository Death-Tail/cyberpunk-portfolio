...
export default function Loading() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-neutral-500/10 to-emerald-500/10 blur-3xl" />
      ...
      ">
        ...
        <div className="
          w-12 h-12
          border-2 border-neutral-400/40
        ...
        <div className="text-center">
          ...
          <p className="text-neutral-400/70 text-sm mt-1">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="absolute bg-neutral-400/20 rounded-full blur-md"
            style={{

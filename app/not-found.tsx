  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="absolute inset-0">
            ...
            Array.from({ length: 30 }).map((_, i) => (
              <div
                ...
                className={`absolute w-1 h-1 rounded-full animate-pulse ${
                  i % 3 === 0 ? "bg-red-500/40" : i % 3 === 1 ? "bg-yellow-500/40" : "bg-blue-500/40"
                }`}
                style={{
        ...
        <div className="absolute top-6 left-6">
          <div className="relative">
            <div className="w-8 h-8 border-l-2 border-t-2 border-red-500 animate-pulse"></div>
            <div className="absolute -top-1 -left-1 w-2 h-2 bg-red-500 rounded-full"></div>
            <div className="absolute top-2 left-2 text-red-400 text-xs">狐</div>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 right-6">
          <div className="relative">
            <div className="w-8 h-8 border-r-2 border-b-2 border-red-500 animate-pulse delay-1000"></div>
            <div className="absolute -bottom-1 -right-1 w-2 h-2 bg-red-500 rounded-full"></div>
            <div className="absolute bottom-2 right-2 text-red-400 text-xs">狐</div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="text-center lg:text-left">
            <div
              className="text-7xl md:text-8xl  font-bold text-red-500 mb-4 relative inline-block"
              style={{
          ...
          <div className="border-2 border-red-500/30 bg-linear-to-br from-red-950/20 to-black/80 backdrop-blur-sm">
            <div className="border-b border-red-500/30 p-3 bg-red-500/10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-red-400 text-xs  ml-2">KITSUNE_OS_ERROR.log</span>
              </div>
            </div>

            <div className="p-6 space-y-3">
              <h1 className="text-xl font-bold text-red-400 ">PAGE_NOT_FOUND</h1>
              <div className="space-y-2 text-sm ">
                ...
                <p className="text-red-400/90">
                  <span className="text-red-500">[WARN]</span> Tails are pointing to alternative routes
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="border border-red-500/40 bg-red-500/10 p-3 text-center backdrop-blur-sm">
              <div className="text-red-400 text-lg font-bold ">404</div>
          ...
          <div className="border-2 border-red-500/40 bg-linear-to-br from-red-950/10 to-black/60 backdrop-blur-sm">
            <div className="border-b border-red-500/30 p-3 bg-red-500/5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-red-400 text-xs  tracking-wider">KITSUNE_INTERFACE</span>
                </div>
                <div className="flex items-center gap-1">
                  <Eye
                    className={`w-3 h-3 text-red-400 transition-opacity duration-150 ${foxEyes ? "opacity-100" : "opacity-30"}`}
                  />
                  <Eye
                    className={`w-3 h-3 text-red-400 transition-opacity duration-150 ${foxEyes ? "opacity-100" : "opacity-30"}`}
                  />
            ...
            <div className="p-8">
              ...
              <div className="relative w-full h-80 border-2 border-dashed border-red-400/30 rounded-lg flex items-center justify-center bg-linear-to-br from-red-900/20 to-yellow-900/10">
                ...
                <div className="absolute inset-0 border-2 border-red-400/20 rounded-lg animate-pulse"></div>
          ...
          <div className="border border-blue-500/40 bg-blue-500/5 p-4 backdrop-blur-sm">
            ...
            >
              ...
              <div className="flex gap-1">
                <div className="w-1 h-1 bg-red-400 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping transition-all delay-100"></div>
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center">
        <div className="text-red-400/60 text-xs ">KITSUNE_OS v2.077 | Nine Tails Computing Corp.</div>
        <div className="text-red-400/40 text-xs  mt-1">
